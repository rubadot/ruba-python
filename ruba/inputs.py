...
class BenefitSlackSharedChannelCreateProperties(typing.TypedDict):
    ...
    """Ruba Slack integration to use for this benefit."""
...
class OAuth2ClientConfiguration(typing.TypedDict):
    ...
    grant_types: typing.NotRequired[
        list[typing.Literal["authorization_code"] | typing.Literal["refresh_token"]]
    ]
...
class OrganizationFeatureSettingsUpdate(typing.TypedDict):
    ...
    Other feature settings are managed by Ruba staff: they're ignored if
...
You can store up to **50 key-value pairs**."""
    ...
    attached_custom_fields: typing.NotRequired[list[AttachedCustomFieldCreate] | None]
...
MetadataQuery: typing.TypeAlias = (
    dict[str, str | int | bool | list[str] | list[int] | list[bool]] | None
)
