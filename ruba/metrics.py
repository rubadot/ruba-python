...
from ruba.errors import (
    HTTPValidationError,
)
from ruba.inputs import (
...
class MetricsSync(SyncServiceBase):
    def get(
        ...
        *,
        ...
        billing_type: ProductBillingType | list[ProductBillingType] | None = None,
        ...
        **Scopes**: `metrics:read`
        ...
        Raises:
            ...
            RubaNetworkError: Raised when a network error occurs while making the request.
            RubaServerError: Raised when the server returns a 5xx error response.
        """
    ...
    def list_dashboards(
        ...
        **Scopes**: `metrics:read`
        ...
        return parse_response_json(response, list[MetricDashboardSchema], method_errors)
